        ...
        <div className="mt-8 space-y-6">
          <div className="text-center">
            <button
              ...
              disabled={loading}
              className="bg-gray-900 hover:bg-gray-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-bold py-2 px-4 rounded flex items-center justify-center w-full transition-colors duration-200"
            >
              {loading ? (
                <>
